                                                        ...
                                                        @foreach ($item['protectme']['method'] as $method => $info)
                                                            ...
                                                            <div class="form-check">
                                                                ...
                                                                <label class="custom-switch ps-0">
                                                                    <span
                                                                        class="custom-switch-description  tx-20 me-2"></span>
                                                                    <input type="checkbox" name="levelsetting[]"
                                                                        class="custom-switch-input" {{ $check }}
                                                                        value="{{ $checkbox_value }}">
                                                                    <span
                                                                        class="custom-switch-indicator
                                                                        custom-switch-indicator-md"></span>
                                                                </label>
                                                                <label class="form-check-label">{!! $info['title'] !!}
                                                                </label>
                                                            </div>
                                                        @endforeach
                                                    </div>
