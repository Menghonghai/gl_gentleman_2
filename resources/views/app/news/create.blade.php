...
<script src="{{ asset('public/assets/plugins/jquery.maskedinput/jquery.maskedinput.js') }}"></script>
    <script>
        $(document).ready(function() {
            ...
            $('#datepicker-date-single-start').bootstrapdatepicker({
                    format: "dd-mm-yyyy",
                    viewMode: "date",
                    multidate: false,
                    multidateSeparator: "|",
                })
                $('#datepicker-date-single-end').bootstrapdatepicker({
                    format: "dd-mm-yyyy",
                    viewMode: "date",
                    multidate: false,
                    multidateSeparator: "|",
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row row-sm">
                                    ...
                                    <div class="dropify-wrapper has-preview" style="height: 350px;">
                                        ...
                                        <div class="dropify-preview" style="display: block;"><span
                                                class="dropify-render"><img
                                                    src="{{ asset('storage/app/news/' . $input['image_url'] ?? '') }}"
                        ...
                        <div class="col-6">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for=""><b>@lang('table.article')</b><span class="text-danger">*</span></label>
                                    <div class="input-group my-group" style="width:100%;">
                                        <div class="input-group-text">
                                            <i class="fas fa-newspaper"></i>
                                        </div>
                                        <select class="form-control input-sm" name="article_tag" id="article_tag">
                                            <option value="">--{{ __('dev.non_select') }} --</option>
                                            {!! cmb_listing(['news' => __('table.news'), 'promotion' => __('table.promotion')], [$input['article_tag'] ?? ''], '', '') !!}
                                        </select>
                                        <span id="article_tag-{{ config('me.app.project_lang')['en'][0] }}-error"
                                            class="error invalid-feedback" style="display: none"></span>
                                    </div>
    
                                    <span id="article_tag-error" class="error invalid-feedback" style="display: none"></span>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for=""><b>@lang('table.start_date')</b></label>
                                            <div class="input-group my-group" style="width:100%;">
                                                <div class="input-group-text">
                                                    <i class="typcn typcn-calendar-outline tx-24 lh--9 op-6"></i>
                                                </div>
                                                <input class="form-control" id="datepicker-date-single-start" placeholder="@lang('table.date_placeholder')" type="text"
                                                name="start_date" value="{{ $input['start_date'] ?? '' }}">
                                                <span id="title-{{ config('me.app.project_lang')['en'][0] }}-error"
                                                    class="error invalid-feedback" style="display: none"></span>
                                            </div>
            
                                            <span id="start_date-error" class="error invalid-feedback" style="display: none"></span>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for=""><b>@lang('table.end_date')</b></label>
                                            <div class="input-group my-group" style="width:100%;">
                                                <div class="input-group-text">
                                                    <i class="typcn typcn-calendar-outline tx-24 lh--9 op-6"></i>
                                                </div>
                                                <input class="form-control" id="datepicker-date-single-end" placeholder="@lang('table.date_placeholder')" type="text"
                                                name="end_date" value="{{ $input['end_date'] ?? '' }}">
                                                <span id="title-{{ config('me.app.project_lang')['en'][0] }}-error"
                                                    class="error invalid-feedback" style="display: none"></span>
                                            </div>
            
                                            <span id="end_date-error" class="error invalid-feedback" style="display: none"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for=""><i class="fas fa-envelope-open-text"></i> <b>@lang('table.content')</b></label>
                                                                ...
                                                                <div class="tab-content">
                                                                    @foreach (config('me.app.project_lang') as $tab_ind => $lang)
                                                                        <div class="tab-pane {{ $tab_ind == 'en' ? 'active' : '' }}"
                                                                            id="tab{{ $lang[0] }}">
                                                                            <textarea class="summernote" id="content-{{ $lang[0] }}" name="content-{{ $lang[0] }}">

                                                                                {!! html_entity_decode($content[$lang[0]] ?? '') !!}
                                                                            </textarea>
                                                                        </div>
                                                                    @endforeach
