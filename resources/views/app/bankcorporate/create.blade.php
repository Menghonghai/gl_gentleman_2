                    ...
                    <div class="row">
                                    ...
                                    <div class="dropify-wrapper has-preview" style="height: 350px;">
                                        ...
                                        <div class="dropify-preview" style="display: block;"><span
                                                class="dropify-render"><img
                                                    src="{{ asset('storage/app/bankcorporate/' . $input['image_url'] ?? '') }}"
                        ...
                        <div class="col-7">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for=""><b>@lang('table.account_number')</b></label>
                                        <div class="input-group my-group" style="width:100%;">
                    
                                            <select class="form-control form-select input-sm tab_title" style="width:25%;">
                                                @foreach (config('me.app.project_lang') as $lang)
                                                    <option value="@lang($lang[0])">@lang('table.account_' . $lang[0])</option>
                                                @endforeach
                                            ...
                                            @foreach (config('me.app.project_lang') as $lang)
                                                ...
                                                @endphp
                                                <input type="text" class="form-control input-sm {{ $active }}" style="width:75%;"
                                                    name="account-{{ $lang[0] }}" id="title-{{ $lang[0] }}"
                                                    placeholder="@lang('table.account_' . $lang[0])" value="{{ $account_number[$lang[0]] ?? '' }}">
                                                @php
                                                    $active = 'hide';
                                                @endphp
                                            @endforeach
