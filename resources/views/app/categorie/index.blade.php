                        ...
                        <tbody>
                            @foreach ($results as $key =>  $categories)
                                <tr>
                                        ...
                                        <div class="form-group">
                                            <label class="custom-switch ps-0">
                                                <input type="checkbox" name="status" class="custom-switch-input status"
                                                    {{ $categories->status == 'yes' ? 'checked' : '' }}>
                                                    <a class="dropdown-item url"
                                                        href="{{ url_builder($obj_info['routing'], [$obj_info['name'], 'status', $categories->categorie_id], ['status=' . $categories->status]) }}">
                                                    </a>
                                    ...
                                    <td>
                                        @php
                                            $edit = checkpermission('categories-edit', $userinfo);
                                            $trash = checkpermission('categories-trash', $userinfo);
                                        @endphp
