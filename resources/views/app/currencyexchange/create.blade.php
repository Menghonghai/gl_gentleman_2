                    ...
                    <div class="row row-sm">
                        <div class="col-6">
                            <div class="form-group">
                                <label for=""><b>@lang('table.buy_price')</b></label>
                                <div class="input-group my-group" style="width:100%;">
                                    <div class="input-group-text">
                                        ៛
                                    </div>
                                    <input aria-label="Amount (to the nearest dollar)" class="form-control" type="number" name="buy_in" value="{{ $input['buy_in'] ?? '' }}">
                                    <span class="input-group-text">.00 @lang('table.riel')</span>
                                    <span id="account-{{ config('me.app.project_lang')['en'][0] }}-error"
                                        class="error invalid-feedback" style="display: none"></span>
                                </div>

                                <span id="buy_in-error" class="error invalid-feedback" style="display: none"></span>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for=""><b>@lang('table.sell_price')</b></label>
                                <div class="input-group my-group" style="width:100%;">
                                    <div class="input-group-text">
                                        ៛
                                    </div>
                                    <input aria-label="Amount (to the nearest dollar)" class="form-control" type="number" name="sold_out" value="{{ $input['sold_out'] ?? '' }}">
                                    <span class="input-group-text">.00 @lang('table.riel')</span>
                                    <span id="account-{{ config('me.app.project_lang')['en'][0] }}-error"
                                        class="error invalid-feedback" style="display: none"></span>
                                </div>

                                <span id="sold_out-error" class="error invalid-feedback" style="display: none"></span>
                            </div>
                        </div>
