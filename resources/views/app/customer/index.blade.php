                ...
                <div class="form-row d-flex justify-content-end" style="font-size: 11px">
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control input-sm" name="txtcustomer" id="txt" placeholder="@lang('table.search_here')"
                ...
                <div class="card-body table-responsive p-0 mg-t-20">
                    <table class="table  table-striped table-hover text-nowrap table-bordered">
                        ...
                        <tr style="text-align: center">
                            ...
                            <th style="width: 10%">@lang('table.phone_number')</th>
                        ...
                        <tbody>
                            @foreach ($results as $key => $customers)
                                <tr>
                                    <td>
                                    ...
                                    <td style="width: 5%">
                                        @if (empty($customers->gender))
                                            <p class="pd-t-15" style="color: #f00">(@lang('table.empty'))</p>
                                        @elseif ($customers->gender == 'male')
                                            @lang('table.male')
                                    ...
                                    <td>
                                        @if (empty($customers->phone_number))
                                            <justify style="color: red">(@lang('table.empty'))</justify>
                                        @else
                                    ...
                                    <td style="width: 10%"> @php
                                        // dd($input);
                                        $date_array = [];
                                        $timestamp = strtotime($customers->create_date);
                                        ...
                                        <div class="form-group">
                                            <label class="custom-switch ps-0">
                                                <input type="checkbox" name="status" class="custom-switch-input status"
                                                    {{ $customers->status == 'yes' ? 'checked' : '' }}>
                                                <a class="dropdown-item url"
                                                    href="{{ url_builder($obj_info['routing'], [$obj_info['name'], 'status', $customers->customer_id], ['status=' . $customers->status]) }}">
                                                </a>
                                    ...
                                    <td>
                                        @php
                                            $edit = checkpermission('customer-edit', $userinfo);
                                            $trash = checkpermission('customer-totrash', $userinfo);
                                        @endphp
                                        @include('app._include.btn_record', [
                                            'rowid' => $customers->customer_id,
