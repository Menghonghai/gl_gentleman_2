                            ...
                            @foreach ($results as $key => $products)
                                ...
                                <tr>
                                        ...
                                        <div class="form-group">
                                            <label class="custom-switch ps-0">
                                                <input type="checkbox" name="status" class="custom-switch-input status"
                                                    {{ $products->status_product == 'yes' ? 'checked' : '' }}>
                                                    <a class="dropdown-item url"
                                                    href="{{ url_builder($obj_info['routing'], [$obj_info['name'], 'status', $products->product_id], ['status=' . $products->status_product]) }}">
                                                </a>
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        @if ($products->status_product == 'yes' )
