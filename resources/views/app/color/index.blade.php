...
@push('page_css')
    ...
    @section('content')
        ...
        <div class="container-fluid">
            ...
            <form style="padding-top: 10px"s class="frmsearch-{{ $obj_info['name'] }}">
                <div class="form-row d-flex justify-content-end" style="font-size: 11px">
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control input-sm" name="txtcolor" id="txt" placeholder="@lang('table.search_here')"
                ...
                <div class="card-body table-responsive p-0 mg-t-20">
                    <table class="table  table-striped table-hover text-nowrap table-bordered">
                        @if (isset($istrash) && $istrash)
                            <thead style="colors: var(--warning)">
                            @else
                                <thead style="colors: var(--info)">
                        @endif
                            ...
                            @foreach ($results as $key =>  $colors)
                                <tr>
                                    ...
                                    <td style="width: 10%"> @php
                                        // dd($input);
                                        $date_array = [];
                                        $timestamp = strtotime($colors->create_date);
                                        ...
                                        <div class="form-group">
                                            <label class="custom-switch ps-0">
                                                <input type="checkbox" name="status" class="custom-switch-input status"
                                                    {{ $colors->status == 'yes' ? 'checked' : '' }}>
                                                    <a class="dropdown-item url"
                                                        href="{{ url_builder($obj_info['routing'], [$obj_info['name'], 'status', $colors->color_id], ['status=' . $colors->status]) }}">
                                                    </a>
                                    ...
                                    <td>
                                        @php
                                            $edit = checkpermission('colors-edit', $userinfo);
                                            $trash = checkpermission('colors-trash', $userinfo);
                                        @endphp
