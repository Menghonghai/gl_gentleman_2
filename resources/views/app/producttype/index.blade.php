                ...
                <div class="form-row d-flex justify-content-end" style="font-size: 11px">
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control input-sm" name="txtproducttype" id="txt" placeholder="@lang('table.search_here')"
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" id="datepicker-date" placeholder="@lang('table.date_placeholder')" type="text"
                                    name="create_date" value="{{ request()->get('create_date') ?? '' }}">
                            </div>
                        </div><!-- input-group -->
                    </div>
            ...
            <form name="frm-2{{ $obj_info['name'] }}" id="frm-2{{ $obj_info['name'] }}" method="POST"
                ...
                <div class="card-body table-responsive p-0 mg-t-20">
                    <table class="table  table-striped table-hover text-nowrap table-bordered">
                        ...
                        <tbody>
                            @foreach ($results as $key => $producttypes)
                                <tr>
                                    <td>
                                    ...
                                    <td style="width: 10%"> @php
                                        // dd($input);
                                        $date_array = [];
                                        $timestamp = strtotime($producttypes->create_date);
                                        ...
                                        <div class="form-group">
                                            <label class="custom-switch ps-0">
                                                <input type="checkbox" name="status" class="custom-switch-input status"
                                                    {{ $producttypes->status == 'yes' ? 'checked' : '' }}>
                                                    <a class="dropdown-item url"
                                                        href="{{ url_builder($obj_info['routing'], [$obj_info['name'], 'status', $producttypes->producttype_id], ['status=' . $producttypes->status]) }}">
                                                    </a>
                                    ...
                                    <td>
                                        @php
                                            $edit = checkpermission('producttype-edit', $userinfo);
                                            $trash = checkpermission('producttype-trash', $userinfo);
                                        @endphp
