                ...
                <div class="form-row justify-content-end">
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control input-sm" name="txtvendor" id="txt" placeholder="@lang('table.search_here')"
            ...
            <form name="frm-2{{ $obj_info['name'] }}" id="frm-2{{ $obj_info['name'] }}" method="POST"
                ...
                <div class="card-body table-responsive p-0 mg-t-20">
                    <table class="table  table-striped table-hover text-nowrap table-bordered">
                        ...
                        <tbody>
                            @foreach ($results as $key => $vendors)
                                <tr>
                                    <td>
                                    ...
                                    <td style="width: 10%"> @php
                                        // dd($input);
                                        $date_array = [];
                                        $timestamp = strtotime($vendors->create_date);
                                            ...
                                            <label class="custom-switch ps-0">
                                                <input type="checkbox" name="status" class="custom-switch-input status"
                                                    ...
                                                    <a class="dropdown-item url"
                                                         href="{{ url_builder($obj_info['routing'], [$obj_info['name'], 'status', $vendors->vendor_id], ['status=' . $vendors->status]) }}">
                                                    </a>
                                    ...
                                    <td>
                                        @php
                                            $edit = checkpermission('vendor-edit', $userinfo);
                                            $trash = checkpermission('vendor-trash', $userinfo);
                                        @endphp
