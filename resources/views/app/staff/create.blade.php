            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row row-sm">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-5 col-sm-12">
                            <div class="form-group">
                                <label for="salary"><b>@lang('table.salary')</b></label>
                                <div class="input-group my-group" style="width:100%;">
                                    ...
                                    <input type="number" class="form-control" name="salary" id="salary"
                                        placeholder="@lang('table.enter') @lang('table.salary')"
                                        value="{{ $input['salary'] ?? '' }}">
                                    <span id="title-{{ config('me.app.project_lang')['en'][0] }}-error"
                                        class="error invalid-feedback" style="display: none"></span>
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-5 col-sm-12">
                            <div class="form-group">
                                <label for=""><b>@lang('dev.address')</b></label>
                                <div class="input-group my-group" style="width:100%;">
                                    ...
                                    @foreach (config('me.app.project_lang') as $lang)
                                        ...
                                        @endphp
                                        <input type="text" class="form-control input-sm {{ $active }}"
                                            style="width:75%;" name="address-{{ $lang[0] }}"
                                            id="title-{{ $lang[0] }}" placeholder="@lang('dev.lang_' . $lang[0])"
                                            value="{{ $address[$lang[0]] ?? '' }}">
                                        @php
                                            $active = 'hide';
                                        @endphp
                                    @endforeach
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-5 col-sm-12">
                            <div class="form-group">
                                <label for=""><b>@lang('dev.pob')</b></label>
                                <div class="input-group my-group" style="width:100%;">
                                    ...
                                    @foreach (config('me.app.project_lang') as $lang)
                                        ...
                                        @endphp
                                        <input type="text" class="form-control input-sm {{ $active }}"
                                            style="width:75%;" name="pob-{{ $lang[0] }}"
                                            id="title-{{ $lang[0] }}" placeholder="@lang('dev.lang_' . $lang[0])"
                                            value="{{ $pob[$lang[0]] ?? '' }}">
                                        @php
                                            $active = 'hide';
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-5 col-sm-12">
                            <div class="form-group">
                                <label for="dob"><b>@lang('table.dob')</b></label>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-5 col-sm-12">
                            <div class="form-group">
                                <label for="hire_date"><b>@lang('table.hire_date')</b></label>
                                <div class="input-group my-group" style="width:100%;">
                                    <div class="input-group-text">
                                        <i class="typcn typcn-calendar-outline tx-24 lh--9 op-6"></i>
                                    </div>
                                    <input type="date" class="form-control" name="hire_date" id="hire_date"
                                        value="{{ $input['hire_date'] ?? '' }}">
                                    <span id="title-{{ config('me.app.project_lang')['en'][0] }}-error"
                                        class="error invalid-feedback" style="display: none"></span>
                                </div>
                                <span id="fullname-error" class="error invalid-feedback" style="display: none"></span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group my-group" style="width:100%;">
                                    ...
                                    <input aria-describedby="basic-addon1" class="form-control" id="email"
                                        placeholder="@lang('table.email')" type="email" name="email"
                                        value="{{ $input['email'] ?? '' }}">
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-5 col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-group my-group" style="width:100%;">
                                    ...
                                    <input aria-describedby="basic-addon1" class="form-control" id="phone_number"
                                        placeholder="@lang('table.phone_number')" type="number" name="phone_number"
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" id="phoneMask" placeholder="(000) 000-0000"
                            ...
                            <div class="profile-tab tab-menu-heading border-bottom-0">
                                <nav class="nav main-nav-line p-0 tabs-menu profile-nav-line border-0 br-5 mb-0	">
                                    ...
                                    <a class="nav-link mb-2 mt-2" data-bs-toggle="tab"
                                        href="#id_card">@lang('dev.id_card')</a>
                                    <a class="nav-link  mb-2 mt-2" data-bs-toggle="tab"
                                        href="#image_cv">@lang('dev.image_cv')</a>
                                    <a class="nav-link  mb-2 mt-2" data-bs-toggle="tab"
                                        href="#description">@lang('dev.job_description')</a>
                                </nav>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="main-content-body tab-pane border-top-0" id="id_card">
                                <div class="card">
                                    <div class="card-body p-0 border-0 p-0 rounded-10">
                                        <div class="p-4">
                                            <h4 class="tx-15 text-uppercase mb-3">@lang('dev.id_card')</h4>
                            ...
                            <div class="main-content-body  tab-pane border-top-0" id="image_cv">
                                <div class="card">
                                    <div class="card-body p-0 border-0 p-0 rounded-10">
                                        <div class="p-4">
                                            <h4 class="tx-15 text-uppercase mb-3">@lang('dev.image_cv')</h4>
                                            <div class="form-group create_img2">
                                                <div class="input-group my-group" style="width:70%;">
                                                    <input type="file" class="dropify" data-height="900"
                                                        accept="image/png, image/jpeg,image/PNG, image/JPEG,image/jpg,image/JPG"
                                                        name="images_cv" value="" />
                                                    <span id="title-{{ config('me.app.project_lang')['en'][0] }}-error"
                                                        class="error invalid-feedback" style="display: none"></span>
                                                </div>
                                                <span id="type-error" class="error invalid-feedback"
                                            ...
                                            @if (isset($input))
                                                <div class="input-group my-group update_img2" style="width:70%;">
                                                    <div class="dropify-wrapper has-preview" style="height: 900px;">
                                                        <div class="dropify-message"><span class="file-icon">
                                                            </span>
                                                            <p class="dropify-error">Ooops, something wrong appended.</p>
                                                        </div>
                                                        ...
                                                        <div class="dropify-errors-container">
                                                            <ul></ul>
                                                        </div><input type="file" class="dropify" data-height="900"
                                                            accept="image/png, image/jpeg,image/PNG, image/JPEG,image/jpg,image/JPG"
                                                            name="" value=""
                                                            data-date="3331-09-10T00:00:00+07:00"><button type="button"
                                                            id="remove2"
                                                        ...
                                                        <div class="dropify-preview" style="display: block;"><span
                                                                class="dropify-render"><img
                                                                    src="{{ asset('storage/app/cv/' . $input['cv_document'] ?? '') }}"
                                                                    style="max-height: 900px;"></span>
                                                            <div class="dropify-infos">
                                                                <div class="dropify-infos-inner">
                                                                    <p class="dropify-filename"><span
                                                                            class="dropify-filename-inner"></span>
