...
{
    //
    private $obj_info = ['name' => 'products', 'routing' => 'admin.controller', 'title' => 'Product', 'icon' => '<i class="text-muted fa fa-cubes"></i>'];
    public $args;
    ...
    public function __construct(array $args = [])
    {
        ...
        $this->main_model = new Mainproducts;
    ...
    public function default()
    {
        ...
        return ['categorie' => $categorie, 'vendor' => $vendor, 'color' => $color];
    } /*../function..*/
    public function listingModel()
    {
        ...
        return $this->model
            ...
            ->select(
                \DB::raw($this->fprimarykey . ",JSON_UNQUOTE(JSON_EXTRACT(" . $this->tablename . ".name,'$." . $this->dflang[0] . "')) AS text,tblproducts.code,tblproducts.qty_stock,tblproducts.cost,tblproducts.price,tblproducts.create_date,tblproducts.update_date,tblproducts.status,
